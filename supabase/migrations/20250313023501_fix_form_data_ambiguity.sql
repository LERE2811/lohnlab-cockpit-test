-- Migration to fix ambiguous column reference in extract_onboarding_data function
-- This migration recreates the function with proper variable naming to avoid ambiguity
...
-- Drop and recreate the extract_onboarding_data function with fixed variable names
